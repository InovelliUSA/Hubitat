...
metadata {
    definition (name: "Inovelli VZM36 Zigbee Canopy Light", namespace: "InovelliUSA", author: "M.Amber/E.Maycock", importUrl:"https://raw.githubusercontent.com/InovelliUSA/Hubitat/master/Drivers/inovelli-fan-light-canopy-module-blue-series-vzm36.src/VZM36_Zigbee_Canopy_Light.groovy")
	{
...
def cycleSpeed() {    // FOR FAN ONLY
    ...
    if (parameter158=="1" || parameter258=="1") {
		...
		cmds += "he cmd 0x${parent.deviceNetworkId} 0x${device.deviceNetworkId?.substring(device.deviceNetworkId.length()-2)?:"00"} 0x0008 0x04 {33 FFFF}"
    }
...
def readDeviceAttributes() {
	...
	parent.readDeviceAttributes(device.deviceNetworkId)
}
...
def setLevel(level, duration=0xFFFF) {
    ...
    //cmds += zigbee.setLevel(level,duration,shortDelay)
